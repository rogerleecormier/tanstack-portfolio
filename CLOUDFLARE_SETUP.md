...
This guide explains how to set up Cloudflare Access with Google SSO to protect your routes `/protected` and `/healthbridge-analysis`.
...
3. **Google Workspace** or **Google Cloud Project** for SSO
...
## Step 2: Configure Google SSO Identity Provider
...
### 2. User Management
- Regular review of allowed users
