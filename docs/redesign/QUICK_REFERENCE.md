...
<div className="mb-12">
  ...
  <div className="w-16 h-1 bg-gradient-to-r from-strategy-gold to-transparent" />
...
### Card Wrapper
```tsx
<div className="bg-surface-elevated border border-border-subtle rounded-lg p-8 hover:border-strategy-gold hover:shadow-lg transition-all">
  {/* content */}
</div>
```
...
```tsx
<section className="bg-gradient-to-b from-surface-elevated to-surface-base border border-border-subtle rounded-lg p-16 mb-24 grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
