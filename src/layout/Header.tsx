      ...
      <div className="mx-auto max-w-7xl px-4 py-4 md:px-8">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/" className="flex items-center gap-2 shrink-0">
              ...
              <div className="hidden sm:block">
                <h1 className="text-base md:text-lg font-bold text-text-foreground leading-tight">
                  Roger Lee Cormier
                </h1>
                <p className="text-xs font-semibold uppercase tracking-widest text-strategy-gold leading-tight">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="hidden md:block max-w-sm flex-1">
              <RedesignedSearch />
            </div>
