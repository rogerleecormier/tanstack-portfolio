  ...
  return (
    <SidebarProvider defaultOpen={defaultSidebarOpen}>
      <div className="min-h-screen flex bg-gray-50">
        ...
        {/* Main Content Area - Critical: Remove SidebarInset wrapper that breaks sticky */}
        <div className="flex flex-col flex-1 min-w-0">
          {/* Header - Now can be sticky */}
          <Header />
          
          <div className="flex flex-1">
            {/* Main Content - Remove overflow constraints */}
            <main className="flex-1 p-4 sm:p-6 lg:p-8 xl:p-12">
            ...
            {/* Right Sidebar - Table of Contents - Now can be sticky */}
