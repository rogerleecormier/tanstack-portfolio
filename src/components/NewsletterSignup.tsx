  ...
  if (variant === 'compact') {
    return (
      <div className={cn('mt-8 pt-6 border-t border-gray-200', className)}>
        ...
        {message && (
          <div className={cn('flex items-center justify-center gap-2 text-sm mt-3', getStatusColor())}>
            {getStatusIcon()}
            <span>{message}</span>
          </div>
        )}
    ...
    <div className={cn('mt-16 pt-8 border-t border-gray-200', className)}>
      <Card className="text-center">
        <CardContent className="py-8">
          ...
          {message && (
            <div className={cn('flex items-center justify-center gap-2 text-sm mt-4', getStatusColor())}>
              {getStatusIcon()}
              <span>{message}</span>
            </div>
          )}
