        ...
        <div className='space-y-4'>
          ...
          <div className='p-3 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-700'>
            <div className='flex items-center gap-2 mb-2'>
              ...
              <span className='text-xs uppercase font-semibold text-teal-700 dark:text-teal-300'>
                Title
              </span>
            </div>
          ...
          <div className='grid grid-cols-2 gap-3'>
            <div className='p-3 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-700'>
              <div className='flex items-center gap-2 mb-1'>
                ...
                <span className='text-xs uppercase font-semibold text-purple-700 dark:text-purple-300'>
                  Date
                </span>
              </div>
            ...
            <div className='p-3 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-700'>
              <div className='flex items-center gap-2 mb-1'>
                ...
                <span className='text-xs uppercase font-semibold text-orange-700 dark:text-orange-300'>
                  Layout
                </span>
              </div>
              <div className='text-sm text-slate-800 dark:text-slate-200'>
