...
export const Logo: React.FC<LogoProps> = ({
  ...
  if (variant === 'icon-only') {
    return (
      <div className={`${sizeClass} ${className}`}>
        ...
        />
        <div
          className={`${sizeClass} hidden items-center justify-center rounded-2xl border border-hunter-500/50 bg-gradient-to-br from-hunter-700 to-hunter-800 shadow-lg`}
        >
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div
        className={`${sizeClass} hidden items-center justify-center rounded-2xl bg-gradient-to-br from-hunter-700 to-hunter-800 shadow-lg`}
      >
        <Target className='size-1/2 text-white' />
      </div>
      ...
      {showTargetingDots && (
        <>
          ...
          <div
            className={`absolute -bottom-1 -left-1 ${dotSize.outer} flex items-center justify-center rounded-full border border-hunter-500/50 bg-gradient-to-br from-hunter-600 to-hunter-700 shadow-md`}
          >
            <div className={`${dotSize.inner} rounded-full bg-white`}></div>
          </div>
        </>
