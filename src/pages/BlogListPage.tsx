    ...
    <div className='min-h-screen bg-surface-deep'>
            ...
            <div className='mb-4 flex items-center justify-center gap-4'>
              ...
              <div>
                <h1 className='text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl'>
                  <span className='text-strategy-gold'>Insights & Articles</span>
                </h1>
      ...
      <div className='mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8'>
        ...
        <Dialog open={isTagFilterOpen} onOpenChange={setIsTagFilterOpen}>
          <DialogContent className='z-[200] flex max-h-[85vh] max-w-2xl flex-col border-strategy-gold/20 bg-surface-elevated/50 backdrop-blur-xl dark:border-strategy-gold/20 dark:bg-surface-elevated/30'>
            <DialogHeader>
      ...
      <div className='border-t border-strategy-gold/20 bg-surface-elevated/20 backdrop-blur-xl'>
...
const BlogPostCard: React.FC<BlogPostCardProps> = ({ post }) => {
  return (
    <Card className='group flex h-full flex-col overflow-hidden border-strategy-gold/20 bg-surface-elevated/30 transition-all duration-200 hover:border-strategy-gold/40 hover:bg-hunter-800/40 hover:shadow-lg dark:border-strategy-gold/20 dark:bg-surface-elevated/30'>
      {/* Gold top accent with glassmorphism */}
      <div className='h-1 bg-strategy-gold/60'></div>

      <CardHeader className='pb-4'>
        <CardTitle className='line-clamp-2 text-lg leading-tight text-white transition-colors group-hover:text-strategy-gold'>
          <Link to={`/blog/${post.slug}`} className='hover:no-underline'>
            {post.title}
          </Link>
        </CardTitle>
        <CardDescription className='line-clamp-3 leading-relaxed text-gray-300'>
          {post.description}
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className='flex flex-1 flex-col'>
        ...
        {post.tags.length > 0 && (
          <div className='mb-5 flex flex-wrap gap-2'>
            ...
            {post.tags.length > 3 && (
              <Badge
                variant='secondary'
                className='border-grey-600/30 bg-grey-700/50 text-xs text-gray-300'
              >
        ...
        <div className='mt-auto'>
          <Button
            className='w-full border-0 bg-gold-600/70 font-medium text-hunter-900 transition-all duration-200 hover:bg-strategy-gold group-hover:scale-[1.01] dark:bg-strategy-gold dark:text-hunter-950 dark:hover:bg-gold-400'
            asChild
          >
