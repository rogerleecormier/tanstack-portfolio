        ...
        <div className='container mx-auto px-4 py-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {[...Array(6)].map((_, i) => (
              <Card
                key={i}
                className='h-80 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border-0 shadow-xl'
              >
        ...
        <div className='relative px-4 py-8 sm:px-6 lg:px-8'>
          <div className='mx-auto max-w-4xl text-center'>
            ...
            <div className='mt-6 flex flex-wrap justify-center gap-3'>
              <Badge
                variant='secondary'
                className='bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-200 px-3 py-1.5 text-sm'
              >
              ...
              <Badge
                variant='secondary'
                className='bg-blue-200 text-blue-900 dark:bg-blue-800 dark:text-blue-100 px-3 py-1.5 text-sm'
              >
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {displayedProjects.map(project => {
                  ...
                  return (
                    <Card
                      key={project.id}
                      className='group hover:shadow-xl transition-all duration-300 border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-900 flex flex-col h-full'
                    >
                        ...
                        <div className='flex flex-wrap gap-1.5 mb-3'>
                          {project.tags.slice(0, 3).map((tag, index) => (
                            <Badge
                              key={index}
                              variant='secondary'
                              className='bg-teal-50 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300 text-xs px-2 py-0.5'
                            >
                              {tag}
                            </Badge>
                          ))}
                          {project.tags.length > 3 && (
                            <Badge
                              variant='secondary'
                              className='bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs px-2 py-0.5'
                            >
