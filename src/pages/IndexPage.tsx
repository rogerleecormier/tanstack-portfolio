                        ...
                        <div className='flex flex-wrap gap-1.5 mb-4'>
                          {item.tags.slice(0, 3).map((tag, index) => (
                            <Badge
                              key={index}
                              variant='secondary'
                              className='bg-teal-50 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300 text-xs'
                            >
                              {tag}
                            </Badge>
                          ))}
        ...
        <div className='mx-auto max-w-7xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {recentBlogs.map(blog => (
              <Card
                key={blog.id}
                className='group hover:shadow-xl transition-all duration-300 border border-slate-200/50 dark:border-slate-700/50 bg-slate-50/80 dark:bg-slate-800/80 backdrop-blur-sm hover:bg-slate-100/80 dark:hover:bg-slate-700/80 h-full flex flex-col'
              >
                <CardHeader className='pb-4 flex-shrink-0'>
                  <div className='flex items-center justify-between mb-3'>
                    <Badge
                  ...
                  <div className='flex flex-wrap gap-1.5 mb-4'>
                    {blog.tags.slice(0, 3).map((tag, index) => (
                      <Badge
                        key={index}
                        variant='secondary'
                        className='bg-slate-200 text-slate-800 dark:bg-slate-600 dark:text-slate-200 text-xs border border-slate-300 dark:border-slate-500'
                      >
                        {tag}
                      </Badge>
                    ))}
