    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Site Administration</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Monitor system health, manage services, and access protected resources
          </p>
            ...
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <div className="text-sm font-medium text-gray-500 mb-1">Authentication</div>
                    <div className="text-gray-900 font-medium">{isDevelopment ? 'Development' : 'Cloudflare Access'}</div>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <div className="text-sm font-medium text-gray-500 mb-1">Environment</div>
                    <div className="text-gray-900 font-medium">{isDevelopment ? 'Development' : 'Production'}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-gray-900">Site Administration</span>
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">AI Contact Analyzer</div>
                      <div className="text-sm text-gray-600">AI-powered contact analysis</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.ai === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.ai === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Contact form processing</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.email === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.email === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">Newsletter Service</div>
                      <div className="text-sm text-gray-600">Blog subscription management</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.newsletter === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.newsletter === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">Content Search</div>
                      <div className="text-sm text-gray-600">Semantic content discovery</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.contentSearch === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.contentSearch === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">Health Bridge API</div>
                      <div className="text-sm text-gray-600">External health data service</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.healthBridge === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.healthBridge === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">AI content suggestions</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.smartRecommendations === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.smartRecommendations === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">files.rcormier.dev connectivity</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.r2Bucket === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.r2Bucket === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">Cloudflare Access</div>
                      <div className="text-sm text-gray-600">Authentication & identity verification</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {apiStatus.cloudflareAccess === 'idle' && <div className="w-3 h-3 rounded-full bg-gray-300" />}
                    {apiStatus.cloudflareAccess === 'testing' && <Loader2 className="h-4 w-4 animate-spin text-orange-600" />}
                  ...
                  <div className="space-y-3">
                    {apiResults.ai && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="font-medium text-gray-900">AI Worker</span>
                        <div className="flex items-center gap-2">
                          {apiResults.ai.success ? <CheckCircle className="h-4 w-4 text-green-600" /> : <XCircle className="h-4 w-4 text-red-600" />}
                          <span className={`text-sm font-medium ${apiResults.ai.success ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    {apiResults.email && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm font-medium ${apiResults.email.success ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    {apiResults.newsletter && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="font-medium text-gray-900">Newsletter Service</span>
                        <div className="flex items-center gap-2">
                          {apiResults.newsletter.success ? <CheckCircle className="h-4 w-4 text-green-600" /> : <XCircle className="h-4 w-4 text-red-600" />}
                          <span className={`text-sm font-medium ${apiResults.newsletter.success ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    {apiResults.contentSearch && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="font-medium text-gray-900">Content Search</span>
                        <div className="flex items-center gap-2">
                          {apiResults.contentSearch.success ? <CheckCircle className="h-4 w-4 text-green-600" /> : <XCircle className="h-4 w-4 text-red-600" />}
                          <span className={`text-sm font-medium ${apiResults.contentSearch.success ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    {apiResults.healthBridge && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="font-medium text-gray-900">Health Bridge API</span>
                        <div className="flex items-center gap-2">
                          {apiResults.healthBridge.success ? <CheckCircle className="h-4 w-4 text-green-600" /> : <XCircle className="h-4 w-4 text-red-600" />}
                          <span className={`text-sm font-medium ${apiResults.healthBridge.success ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    {apiResults.smartRecommendations && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm font-medium ${apiResults.smartRecommendations.success ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    {apiResults.r2Bucket && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="font-medium text-gray-900">R2 Bucket</span>
                        <div className="flex items-center gap-2">
                          {apiResults.r2Bucket.success ? <CheckCircle className="h-4 w-4 text-green-600" /> : <XCircle className="h-4 w-4 text-red-600" />}
                          <span className={`text-sm font-medium ${apiResults.r2Bucket.success ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    {apiResults.cloudflareAccess && (
                      <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <span className="font-medium text-gray-900">Cloudflare Access</span>
                          <div className="flex items-center gap-2">
                            {apiResults.cloudflareAccess.success ? <CheckCircle className="h-4 w-4 text-green-600" /> : <XCircle className="h-4 w-4 text-red-600" />}
                            <span className={`text-sm font-medium ${apiResults.cloudflareAccess.success ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg text-sm space-y-3">
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              ...
                              <span className="ml-2 text-gray-600">{apiResults.cloudflareAccess.status} {apiResults.cloudflareAccess.statusText}</span>
                            </div>
                            <div>
                              <span className="font-medium text-gray-700">Cookies:</span>
                              <span className="ml-2 text-gray-600">{apiResults.cloudflareAccess.cookies?.length || 0} found</span>
                            </div>
                          </div>
                          
                          {apiResults.cloudflareAccess.identity && (
                            <div className="bg-white p-3 rounded-lg border border-gray-200">
                              <div className="font-medium text-gray-900 mb-2">Identity:</div>
