              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {displayedItems.map(item => {
                  ...
                  return (
                    <Card
                      key={item.id}
                      className='group h-full bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1'
                    >
                            ...
                            return (
                              <>
                                ...
                                {cleanTags.length > 3 && (
                                  <Badge
                                    variant='secondary'
                                    className='text-xs px-2 py-1 bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 border-0'
                                  >
                                    +{cleanTags.length - 3}
                                  </Badge>
                                )}
